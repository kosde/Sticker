...
<head>
                ...
                if(num.value%10==0)
                {
                    ...
                    if(cantidad!=0)
                    {
                        ...
                        if(cantidad > 50)
                        {
                            ...
                            if(cantidad==60)
                            {
                                var price=precioxunidad*cantidad-precioxunidad*cantidad*0.04;//.675
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                            ...
                            if(cantidad==230)
                            {
                                var price=precioxunidad*cantidad-precioxunidad*cantidad*0.00001;//.675
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
        ...
        function CustomsizeWandH()
        {
            ...
            else
            {
                ...
                if(var3.checked)
                {
                    var elemento = document.getElementById("variant-quantities");
                    elemento.className = " options radio";
                    var precioxunidad = 1.9649999999999999;
                    var price=precioxunidad*50;
                    document.getElementById('price_50_id').innerText="$"+ price.toFixed();
                    document.getElementById("price_50").value = price.toFixed();
                    document.getElementById("quantity_50").setAttribute("onclick", "Custom("+price.toFixed()+");");
    ...
    <script type=text/javascript>
        ...
        function pricescustomWandH1(widthC,heightC)
        {
            ...
            cant500=dcant500-((6.4*widthC)+(6.4*heightC)); 
            cant1000=dcant1000-((6.8*widthC)+(6.8*heightC)); 
            cant2000=dcant2000-((6.9*widthC)+(6.9*heightC)); 
            cant3000=dcant3000-((5.7*widthC)+(5.7*heightC)); 
            cant5000=dcant5000-((5.7*widthC)+(5.7*heightC)); 
            cant10000=dcant10000-((5.7*widthC)+(5.7*heightC));
            ...
            <div class="wrapper_cut bg-image-container">
                <div class="text-dark">
                    ...
                    <div class="front">
                        ...
                        <p>Custom Bumper Stickers are a fast and easy way to promote your business, brand or event.  Thick, durable vinyl protects your stickers from scratches, water &amp; sunlight.</p>
                    ...
                    <div class="product">
                        <form action="upload.php?price=57" class="product-options" method="get" id="form_id">
                            ...
                            <div class="continue" id="continue">
                                <button class="button large secondary block" name="filename" value="Bumper stickers">Continue</button>
                    ...
                    <div class="grid3 grid_product">
                        <div class="wrapperproducts_sin text-dark" style="padding: 10px 0 10px 0;">
                            <div class="image_car">
                                ...
                                <p style="text-align: center;">Get your bumper stickers fast with 4 day turnaround.</p>
                        </div>
                        <div class="wrapperproducts_sin text-dark" style="padding: 10px 0 10px 0;">
                            <div class="image_car">
                        ...
                        <div class="wrapperproducts_sin text-dark" style="padding: 10px 0 10px 0;">
                            <div class="image_car">
                                ...
                                <p style="text-align: center;">Thick, durable vinyl protects your bumper stickers from scratching, rain & sunlight.</p>
                        </div>
