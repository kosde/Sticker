...
<head>
    ...
    <!--<script type=text/javascript>
            ...
            if(num.value>10)
            {
                if(num.value%10==0)
                {
                    ...
                    if(cantidad!=0)
                    {
                        ...
                        var precioxunidadW = .41+(size1*0.06); //.06
                        var precioxunidadH = .41+(size2*0.06); //.06
        ...
        function CustomsizeWandH()
        {
            ...
            else
            {
                ...
                if(var1.checked)
                {
                    ...
                    var precioxunidad = 1.1800000000000002;
                ...
                if(var3.checked)
                {
                    var elemento = document.getElementById("variant-quantities");
                    elemento.className = " options radio";
                    var precioxunidad = 1.3599999999999999;
                    var price=precioxunidad*50;
                    document.getElementById('price_50_id').innerText="$"+ price.toFixed();
                    document.getElementById("price_50").value = price.toFixed();
                    document.getElementById("quantity_50").setAttribute("onclick", "Custom("+price.toFixed()+");");
        ...
        function CheckcustomW()
        {
            ...
            else
            {
                ...
                if(num.value!=0 && num2.value!=0)
                {
                    var elemento = document.getElementById("variant-quantities");
                    elemento.className = " options radio";
                    var precioxunidadW = .44+(num.value*0.06); //.06
                    var precioxunidadH = .44+(num2.value*0.06); //.06
                    var precioxunidad = precioxunidadW + precioxunidadH;
                    var price=precioxunidad*50;
        ...
        function CheckcustomH()
        {
            ...
            {
                var precioxunidadW = .44+(widthC*0.06); //.06
                var precioxunidadH = .44+(heightC*0.06); //.06
            ...
            <div class="wrapper_cut bg-image-container">
                <div class="text-dark">
                    ...
                    <div class="front">
                        ...
                        <p>Custom Oval Stickers are a fast and easy way to promote your business, brand or event.  Thick, durable vinyl protects your stickers from scratches, water &amp; sunlight.</p>
                    ...
                    <div class="product">
                        <form action="upload.php?price=57" class="product-options" method="get" id="form_id">
                            ...
                            <div class="continue" id="continue">
                                <button class="button large secondary block"  name="filename" value="Oval stickers">Continue</button>
                    ...
                    <div class="grid3 grid_product">
                        <div class="wrapperproducts_sin text-dark" style="padding: 10px 0 10px 0;">
                            <div class="image_car">
                                ...
                                <p style="text-align: center;">Get your oval stickers fast with 4 day turnaround.</p>
                        </div>
                        <div class="wrapperproducts_sin text-dark" style="padding: 10px 0 10px 0;">
                            <div class="image_car">
                        ...
                        <div class="wrapperproducts_sin text-dark" style="padding: 10px 0 10px 0;">
                            <div class="image_car">
                                ...
                                <p style="text-align: center;">Thick, durable vinyl protects your oval stickers from scratching, rain & sunlight.</p>
                        </div>
