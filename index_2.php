...
<head>
    ...
    <style>
        ...
        .first
        {
            background-color:#d2b94c !important;
        }
        .dt2{
            color: #d2b94c !important;
        }
        .dt1,.color1,.nav-link{
            color: #fff !important;
        }
        .secondary{
            background-image: linear-gradient( to bottom,rgb(195, 48, 88) 0%,rgb(190, 10, 76) 100% );
        }
        .primary{
            background-image: linear-gradient( to bottom,#002c5e 0%,#002157 100% );
        }
        li:hover {
...
<?php include "nav.php"; ?>  
    <main>
        <section class="first mainimage " style="" >
            <div class="container move" style="display:table">
                <div style="display: table-cell;vertical-align: middle;">
                    <div class="slogan">
                        <h1 class="slogantxt" translate="yes" style="color: black !important;">CUSTOM STICKERS DELIVERED TO YOUR DOOR</h1>
                    </div>
                    <div class="sub">
                        <p class="regular2 font-light" translate="yes" style="color: black !important;">EASY ONLINE ORDERING, 4 DAY TURNAROUND AND FREE ONLINE PROOFS. FREE SHIPPING.</p>
                    </div>
        ...
        <section class="container_video" style="height: 100% !important;">
            <div class="container" onscroll="myFunction()">
                ...
                <div class="contentVideo">
                    <strong class="videoTitle" style="text-align: left;color:#c33058;">ACME STICKERS OFFERS... <br>• FREE ONLINE PROOFS. <br>• FREE SHIPPING.<br>• FAST TURNAROUND.</strong>
        ...
        <section class="container_made" style="height: 100% !important;">
            ...
            <h2 class="videoTitle" style="text-align: center;color:#c33058;padding-bottom: 100px;">WHAT OUR STICKERS ARE MADE OFF</h2>
                    ...
                    <div class="col-xl-5 col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-xl-9" style="margin:auto;">
                                <h6 style="text-align: left;color:#c33058;">DOUBLE LAYER  LAMINATE</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9" style="margin:auto;">
                                <h6 style="text-align: left;color:#c33058;">INK LAYER</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9" style="margin:auto;">
                                <h6 style="text-align: left;color:#c33058;">PRINTABLE VINYL</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9" style="margin:auto;">
                                <h6 style="text-align: left;color:#c33058;">WATERPROOF ADHESIVE</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9" style="margin:auto;">
                                <h6 style="text-align: left;color:#c33058;">REMOVABLE BACKING PAPER</h6>
