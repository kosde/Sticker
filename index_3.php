...
<head>
    ...
    <style>
        ...
        .secondary{
            /*background-image: linear-gradient( to bottom,rgb(228, 288, 29) 0%,rgb(228, 288, 29) 100% );*/
            background-image: linear-gradient( to bottom, #e52528 0% 100% );
        }
        .primary{
            background-image: linear-gradient( to bottom,#f86624 0%,#f86624 100% );
        }
        li:hover {
            background-color: #f86624;
        }
        .primary:hover {
            background-color: #f8662494;
        ...
        <section class="first mainimage " style="" >
            <div class="container move" style="display:table">
                <div style="display: table-cell;vertical-align: middle;">
                    <div class="slogan">
                        <h1 class="slogantxt" translate="yes" style="color: #242c5d !important;">CUSTOM STICKERS DELIVERED TO YOUR DOOR</h1>
                    </div>
                    <div class="sub">
                        <p class="regular2 font-light" translate="yes" style="color: white !important;">EASY ONLINE ORDERING, 4 DAY TURNAROUND AND FREE ONLINE PROOFS. FREE SHIPPING.</p>
                    </div>
