...
<nav class="navbar navbar-expand-lg">
        <div class="container">      
            ...
            <a href="../../index.php" class="navbar-brand d-flex" style="padding-top: 5px;padding-left: 45px;">
                ...
                <h4 style="color: #102542;" class="dt">Acme</h4>
                <h4 style="color: #cdd7d6;" class="dt">Stickers</h4>
            </a>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto d-none d-sm-none d-md-block">
                                    <li style="padding-top: 2%;"><a class="nav-link"style="color: #000;" href="../../../custom-stickers.php">Stickers</a></li>
                </ul>
                <ul class="navbar-nav mr-auto d-block d-sm-block d-md-none">
                                    <li style="padding-top: 2%;padding-left: 26px;"><a class="nav-link"style="color: #000;" href="../../../custom-stickers.php">Stickers</a></li>
                    <?php
                ...
                <ul class="navbar-nav mr-auto d-block d-sm-block d-md-none">
                     <li style="width: 100px;padding-left: 2px;" >
                        <a class="nav-link  pl-4" style="padding-right: 1.0rem; color: #000;" href="../../login.php">Log in</a>
                    </li>
                </ul>
                <ul class="navbar-nav mr-auto d-block d-sm-block d-md-none">
                    <li style="width: 85px;">
                        <a class=" nav-link  pl-4" style="padding-right: 0;float: right; color: #000;display: inline-block;" href="../../signup.php">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <?php
                        ...
                        ?>
                            ...
                            <li style="width: 111px;padding-left: 12px;">
                                <a class=" nav-link  pl-4" style="padding-right: 1.0rem; color: #000;display: inline-block;" href="../../signup.php">
                                    <img src="../../assets/bomba.png" class="bomb" width="32" height="32">Sign up
                                </a>
                            </li>
                        <?php
