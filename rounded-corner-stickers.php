            ...
            <div class="wrapper_cut bg-image-container">
                <div class="text-dark">
                    ...
                    <div class="front">
                        ...
                        <p>Custom Rounded Corner Stickers are a fast and easy way to promote your business, brand or event.  Thick, durable vinyl protects your stickers from scratches, water &amp; sunlight.</p>
                    ...
                    <div class="product">
                        <form action="upload.php?price=57" class="product-options" method="get" id="form_id">
                            ...
                            <div class="continue" id="continue">
                                <button class="button large secondary block" name="filename" value="Rounded corner stickers">Continue</button>
                    ...
                    <div class="grid3 grid_product">
                        <div class="wrapperproducts_sin text-dark" style="padding: 10px 0 10px 0;">
                            <div class="image_car">
                                ...
                                <p style="text-align: center;">Get your rounded stickers fast with 4 day turnaround.</p>
                        </div>
                        <div class="wrapperproducts_sin text-dark" style="padding: 10px 0 10px 0;">
                            <div class="image_car">
                        ...
                        <div class="wrapperproducts_sin text-dark" style="padding: 10px 0 10px 0;">
                            <div class="image_car">
                                ...
                                <p style="text-align: center;">Thick, durable vinyl protects your rounded stickers from scratching, rain & sunlight.</p>
                        </div>
