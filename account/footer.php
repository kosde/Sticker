            ...
            <div class="links">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-lg-5 paddingLenguage">
                        <a class="link   font-medium color1" onclick="Changuelanguage()" type="button"><?php echo $_SESSION['Leng']." (".$_SESSION['LengCod'].")";?></a>
                    </div>
                </div>
                <nav class="subnavfooter">
                    <div class="row" style="width: 100%;margin-left: 0px;">
                        <div class="col-xs-12 col-sm-12 col-lg-5 center-text ">
                                <a class="link   font-medium color1" style="padding-left: 30px;" href="../uses.php">Uses</a>
                                <a class="link   font-medium color1" style="padding-left: 30px;"href="../returns.php" >Returns</a>
                                <a class="link   font-medium color1" style="padding-left: 30px;" href="../help/support.php">Help</a>
                                <a class="link   font-medium color1" style="padding-left: 30px;" href="../help/contact_us.php">Contact us</a>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-lg-2 center-text ">
                            <div style="width: 40px;display: inline-block;">
                                <a aria-label="Instagram" class="color1  social-icons" href="https://www.instagram.com/acmestickers/" rel="noopener noreferrer" target="_blank">
                            ...
                            <div style="width: 40px;display: inline-block;">
                                <a aria-label="Facebook" class="color1  social-icons" href="https://www.facebook.com/acmestickers" rel="noopener noreferrer" target="_blank">
                        ...
                        <div class="col-xs-12 col-sm-12 col-lg-5 center-text ">
                            <div class="">
                                <label for="" class="fontlight color1">© 2021<!-- --> <!-- -->Acme Stickers</label>
                                <!-- <p style="display: inline-block;margin-top:0px;">© 2021 Acme Stickers</p>-->
                                <a class="link   font-medium color1" href="/legal/privacy.php" style="margin:0;">Privacy</a>
                                <label for="" class="fontlight"> &nbsp;&amp;&nbsp;</label>
                                <a class="link   font-medium color1" href="/legal/terms.php" >Terms</a>
                                <a class="link   font-medium color1" href="../sitemap.php">&nbsp;&nbsp;Site map</a>
                            </div>
                        </div>
                    </div>
                </nav>
