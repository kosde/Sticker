            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto d-block d-sm-block d-md-none">
                     <li style="width: 100px;padding-left: 2px;" >
                        <a class="nav-link  pl-4" style="padding-right: 1.0rem; color: #000;" href="../login.php" translate="no">Log in</a>
                    </li>
                </ul>
                <ul class="navbar-nav mr-auto d-block d-sm-block d-md-none">
                    <li style="width: 85px;" translate="no">
                        <a class=" nav-link  pl-4" style="padding-right: 0;float: right; color: #000;display: inline-block;" href="../signup.php" translate="no">
                    ...
                    <?php
                        ...
                        ?>
                            ...
                            <li style="width: 111px;padding-left: 12px;">
                                <a class=" nav-link  pl-4" style="padding-right: 1.0rem; color: #000;display: inline-block;" href="../signup.php" translate="no">
                                    <img src="../assets/bomba.png" class="bomb" width="32" height="32" translate="no">Sign up
                                </a>
                            </li>
                        <?php
