<div class="modal-container" id="Phone_number" style="display: none;padding: 50px 30% 35% 30%;"> 
    <div class="modal-content" style="display: inline-table;height: 100%;">
        <h2 style="text-align: center;padding-bottom: 20px;">Change your phone number</h2>
        <label for="message" class="labelfiel font-light" style="text-align: center;width: 100%;display: block;padding-bottom: 20px;">Enter your new phone number</label>
        <form action="../account/save_phone_number.php" method="get">
            ...
            <div class="buttons-2 buttons" style="text-align: center;">
                <button class="button secondary large" style="width: 410px;" type="submit">Save</button>
            </div>
        </form>
