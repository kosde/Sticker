<?php
    session_start();
?>
<div class="modal-container" id="newAddress" > <!--style="display: none;padding: 50px 28% 150px 28%;"-->
    <div class="modal-content"> <!--style="height: 800px;"-->     
        ...
        <form class="alt-form" id="add_new_address" method="get" action="../account/save_new_address.php">
            <div>
                <h4 style="font-weight: 900;font-size: 1.4rem;">New shipping address</h4>
                <?php
                if($d_bill==1)
                {
                    ?>
                    <div style="display: inline-block;width: 100%;">
                        ...
                        <label class="labelfiel" style="width: 280px" for="shipping_name">Same as default billing address</label>
                    </div>
                    <?php
                }
                ?>                
                    ...
                    <div class="mt-15" id="shipping_address_fields">
                        <div class="field select ">
                            ...
                            <div>
                                <div class="field select half right">
                                    ...
                                    <div aria-live="assertive" style="width:100%;"class="inputWrapper " role="alert">
                                        <input style="border: 1px solid #c8c8c8;width:100%;" class="field" name="state" style="" id="administrative_area_level_1" />
                                        <select style="visibility:hidden;display:none;" autocomplete="address-level1" id="state_id" label="State" type="select" class="inputcheckout field" name="stateUS">
                                            <option value=""></option>
                            ...
                            <div class="buttons-2 buttons">
                                <button class="button secondary largeA" style="width: 322px;" onclick="submit_add_new_address()" type="button">Save shipping address</button>
                                <!--<button class="button secondary largeA" style="width: 322px;" type="submit">Save shipping address</button>-->
                                <button class="button primary largeA pr-4" onclick="CloseNewAddress()" type="button">Cancel</button>
                            </div>
                        </div>
                    </div>
                </div>
