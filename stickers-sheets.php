...
<head>
    ...
    <!--<script type=text/javascript>
            ...
            if(num.value>10)
            {
                if(num.value%10==0)
                {
                    ...
                    if(cantidad!=0)
                    {
                        ...
                        var precioxunidadW = .36+(size1*0.06); //.06
                        var precioxunidadH = .36+(size2*0.06); //.06
                        ...
                        if(cantidad > 50)
                        {
                            ...
                            if(cantidad==60)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 6%";
                            }
                            if(cantidad==70)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 12%";
                            }
                            if(cantidad==80)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 18%";
                            }
                            if(cantidad==90)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 24%";
                            }
                            if(cantidad==100)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 30%";
                            }
                            if(cantidad==110)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 31%";
                            }
                            if(cantidad==120)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 32%";
                            }
                            if(cantidad==130)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 33%";
                            }
                            if(cantidad==140)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 34%";
                            }
                            if(cantidad==150)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 35%";
                            }
                            if(cantidad==160)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 36%";
                            }
                            if(cantidad==170)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 37%";
                            }
                            if(cantidad==180)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 38%";
                            }
                            if(cantidad==190)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 39%";
                            }
                            if(cantidad==200)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 40%";
                            }
                            if(cantidad==210)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 41%";
                            }
                            if(cantidad==220)
                            {
                                var price=precioxunidad*cantidad-precioxunidad*cantidad*0.41;//.675
                            ...
                            if(cantidad==230)
                            {
                                var price=precioxunidad*cantidad-precioxunidad*cantidad*0.001;//.675
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 42%";
                            }
                            if(cantidad==240)
                            {
                                var price=precioxunidad*cantidad-precioxunidad*cantidad*0.001;//.675
                            ...
                            if(cantidad==250)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 43%";
                            }
                            if(cantidad==260)
                            {
                                var price=precioxunidad*cantidad-precioxunidad*cantidad*0.43;//.675
                            ...
                            if(cantidad==270)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 44%";
                            }
                            if(cantidad==280)
                            {
                                var price=precioxunidad*cantidad-precioxunidad*cantidad*0.44;//.675
                            ...
                            if(cantidad==290)
                            {
                                ...
                                document.getElementById('spancustomprice').innerText="$"+ price.toFixed();
                                document.getElementById('price_custom').value=price.toFixed();
                                document.getElementById('spancustomsavings').innerText="Save 45%";
                            }
                            if(cantidad==300)
                            {
                                var price=precioxunidad*cantidad-precioxunidad*cantidad*0.35;//.675
                            ...
                            if(cantidad>300 && cantidad<=500)
                            {
                                ...
                                document.getElementById('spancustomsavings').innerText="Save " + impdesc.toFixed() +"%" ;
                            }
        ...
        function CheckcustomW()
        {
            ...
            else
            {
                ...
                if(num.value!=0 && num2.value!=0)
                {
                    var elemento = document.getElementById("variant-quantities");
                    elemento.className = " options radio";
                    var precioxunidadW = .42+(num.value*0.06); //.06
                    var precioxunidadH = .42+(num2.value*0.06); //.06
                    var precioxunidad = precioxunidadW + precioxunidadH;
                    var price=precioxunidad*50;
        ...
        function CheckcustomH()
        {
            ...
            {
                var precioxunidadW = .42+(widthC*0.06); //.06
                var precioxunidadH = .42+(heightC*0.06); //.06
    ...
    <script type=text/javascript>
        ...
        function Custom(price) 
        {
            ...
            if (remember.checked)
            {
                ...
                var list = document.getElementById("spancustom");
                list.remove();
                h.insertAdjacentHTML("beforeend", "<span class='custom-quantity-wrapper' id='customspanquantity'><div aria-live='assertive' class='inputWrapper'role='alert' id='warnning'><input pattern='[0-9]*' style='width: 100px;' id='valorcustom' placeholder='Quantity' type='number' class='' value='' onkeyup='custom()'></div></span>"); 
            } 
            else
            {
                var element =  document.getElementById('customspanquantity');
        ...
        function CheckcustomH()
        {
            ...
            if(num2.value<=36 && num.value<=24)
            {
                ...
                {
                    var msgalertt = document.getElementById("customheight");
                    msgalertt.insertAdjacentHTML("afterbegin", "<div class='tooltiperror' id='tooltiperrorH'><span class='arrow'></span><span class='text'>Min size is 2 inches</span></div>");
                    var elemento = document.getElementById("variant-quantities");
                    var elemento2 = document.getElementById("continue");
                    elemento.className += " disabled";
                    elemento2.className += " disabled";
                }else if(num2.value<3)
                {
                    var msgalertt = document.getElementById("customwidth");
                    msgalertt.insertAdjacentHTML("afterbegin", "<div class='tooltiperror' id='tooltiperrorW'><span class='arrow'></span><span class='text'>Min size is 3 inches</span></div>");
                    var elemento = document.getElementById("variant-quantities");
                    var elemento2 = document.getElementById("continue");
        ...
        function pricescustomWandH1(widthC,heightC)
        {
            if(widthC==1)
            {
                var precioxunidadW = widthC*price1; //.06
            }
            if(heightC==1)
            {
                var precioxunidadH = heightC*price1; //.06 54 48 12
            }
            if(widthC>1)
            {
                var precioxunidadW = widthC*price2; //.06
            }
            if(heightC>1)
            {
                var precioxunidadH = heightC*price2; //.06 54 48 12
            }
            if(widthC>2)
            {
                var precioxunidadW = widthC*price3; //.06
            }
            if(heightC>2)
            {
                var precioxunidadH = heightC*price3; //.06 54 48 12
            }
            if(widthC>25)
            {
                var precioxunidadW = widthC*price4; //.06
            }
            if(heightC>15)
            {
                var precioxunidadH = heightC*price4; //.06 54 48 12
            }
            if(widthC>30)
            {
                var precioxunidadW = widthC*price5; //.06
            }
            if(heightC>20)
            {
                var precioxunidadH = heightC*price5; //.06 54 48 12
            }
            var precioxunidad = precioxunidadW + precioxunidadH;
            //alert(precioxunidadH);
           
            var price=precioxunidad*50;
            cant60=dcant60-((.59*widthC)+(.59*heightC));
            cant100=dcant100-((1.5*widthC)+(1.5*heightC));
            cant200=dcant200-((1.8*widthC)+(1.8*heightC));
            cant300=dcant300-((1.8*widthC)+(1.8*heightC)); 
            cant500=dcant500-((2.4*widthC)+(2.4*heightC)); 
            cant1000=dcant1000-((2.4*widthC)+(2.4*heightC)); 
            cant2000=dcant2000-((2.4*widthC)+(2.4*heightC)); 
            cant3000=dcant3000-((2.4*widthC)+(2.4*heightC)); 
            cant5000=dcant5000-((2.1*widthC)+(2.1*heightC)); 
            cant10000=dcant10000-((2.1*widthC)+(2.1*heightC));
            ...
            <div class="wrapper_cut bg-image-container">
                <div class="text-dark">
                    ...
                    <div class="front">
                        ...
                        <p>Custom Sticker sheets are a fast and easy way to promote your business, brand or event.  Thick, durable vinyl protects your stickers from scratches, water &amp; sunlight.</p>
                    ...
                    <div class="product">
                        <form action="upload.php?price=57" class="product-options" method="get" id="form_id">
                            ...
                            <div class="continue" id="continue">
                                <button class="button large secondary block"  name="filename" value="Stickers sheets">Continue</button>
                    ...
                    <div class="grid3 grid_product">
                        <div class="wrapperproducts_sin text-dark" style="padding: 10px 0 10px 0;">
                            <div class="image_car">
                                ...
                                <p style="text-align: center;">Get your stickers sheets fast with 4 day turnaround.</p>
                        </div>
                        <div class="wrapperproducts_sin text-dark" style="padding: 10px 0 10px 0;">
                            <div class="image_car">
                        ...
                        <div class="wrapperproducts_sin text-dark" style="padding: 10px 0 10px 0;">
                            <div class="image_car">
                                ...
                                <p style="text-align: center;">Thick, durable vinyl protects your stickers sheets from scratching, rain & sunlight.</p>
                        </div>
